...
xbps-rindex -S ~/void-cosmic-repo/repo/x86_64/*.xbps --privkey ~/repo-private-key.pem --signedby "Bella Wagner <belladev109@proton.me>"
xbps-rindex -r ~/void-cosmic-repo/repo/x86_64/
...
if [ "$1" != "glibc" ]; then
	...
	xbps-rindex -S ~/void-cosmic-repo/repo/x86_64-musl/*.xbps --privkey ~/repo-private-key.pem --signedby "Bella Wagner <belladev109@proton.me>"
